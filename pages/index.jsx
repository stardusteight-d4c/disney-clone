  ...
  return (
    <>
      ...
      {!session ? (
        ...
        <main className="overflow-x-hidden relative min-h-screen after:bg-home after:bg-center after:bg-cover after:bg-no-repeat after:bg-fixed after:absolute after:inset-0 after:z-[-1]">
          <Slider />
          <Brands />
